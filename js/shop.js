...
function shopping_get_student_banner_text() {
  var student_message_text = '<h1>All Harvard ID holders can view this course site during the course selection ' +
...
function shopping_get_teacher_banner_text() {
  var shopping_is_active_message = '<h1>Your current class list may include Prospective Enrollees. ' + tooltip_link +
    ...
    'Student contributions will be visible to other students who are also participating in this course. At the ' +
    'end of the course selection period, Prospective Enrollees who have not officially enrolled as Students or Guests ' +
    'in the course through the Registrar’s office will be removed from the class list.</p>';
